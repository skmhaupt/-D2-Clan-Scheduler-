...
function SpecialEvents(props) {
  const [storedActivity, setStoredActivity] = useLocalStorage('SpecialEvent_Activities', []);
  ...
  return (
    <>
      <div className='backgroundContainer'>
        <div className='specialeventsContainer pageContainer'>
          <Button onClick={handleClick} buttonStyle='btn--outline'>Create new Fireteam</Button>
          <h1 className='specialevents'>Special Evetns</h1>
