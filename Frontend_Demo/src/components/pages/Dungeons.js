...
function Dungeons(props) {
  const [storedActivity, setStoredActivity] = useLocalStorage('Dungeon_Activities', []);
  ...
  return (
    <>
      <div className="backgroundContainer">
        <div className='dungeonsContainer pageContainer'>
          <Button onClick={handleClick} buttonStyle='btn--outline'>Create new Fireteam</Button>
          <h1 className='dungeons'>Dungeons</h1>
